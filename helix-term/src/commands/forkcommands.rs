...
use helix_view::{document::DEFAULT_LANGUAGE_NAME, editor::Action, Document, Editor};
...
pub fn expand_expansions(cmd: &str, doc: &Document) -> String {
    ...
    while let Some(chr) = chars.next() {
        ...
        if next_chr.eq_ignore_ascii_case(&'p') {
            maybe_expand(
                next_chr,
                &maybe_path
        ...
        } else if next_chr.eq_ignore_ascii_case(&'r') {
            maybe_expand(
                next_chr,
                &maybe_path
                    .map(|buf| {
        ...
        } else if next_chr.eq_ignore_ascii_case(&'e') {
            maybe_expand(
                next_chr,
                &maybe_path
        ...
        } else if next_chr.eq_ignore_ascii_case(&'n') {
            maybe_expand(
                next_chr,
                &maybe_path
        ...
        } else if next_chr.eq_ignore_ascii_case(&'g') {
            maybe_expand(next_chr, get_git_repo_root().unwrap_or_default().as_ref())
        } else if next_chr.eq_ignore_ascii_case(&'q') {
            maybe_expand(
                next_chr,
                &maybe_path
                    .map(|buf| {
        ...
        } else if next_chr.eq_ignore_ascii_case(&'l') {
            maybe_expand(
                next_chr,
                doc.language_name().unwrap_or(DEFAULT_LANGUAGE_NAME),
            )
        } else if next_chr.eq_ignore_ascii_case(&'h') {
            maybe_expand(
                next_chr,
                &maybe_path
                    .map(|buf| {
        ...
        } else if next_chr.eq_ignore_ascii_case(&'w') {
            maybe_expand(
                next_chr,
