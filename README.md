...
`:uniq` only retains a selection, if its text hasn't appeared already. \
...
### select_character
Expects you to press / type a character, and then selects all matches of that character in your selections. \
Essentially a `select_regex` where you don't have to escape the character nor press <kbd>Enter</kbd>. \
Pressing <kbd>Enter</kbd> / <kbd>Tab</kbd> as a character **does** work.
