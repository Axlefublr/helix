...
# I'm sorry
¹ for using letters here instead of the special characters as was in the blog post; I'm trying out a new mapping system for harps to increase my usage of them and having all that important jazz on nicer to press keys is pretty crucial. \
