...
<kbd>ctrl+i</kbd> toggles surrounding your input with `\b` (toggling word bounds) \
...
After invoking a harp action, press <kbd>Space</kbd> or <kbd>'</kbd> to toggle between get / set.
